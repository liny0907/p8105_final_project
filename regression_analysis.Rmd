...
`city`: city name
`pm25_diff` mean pm2.5 AQI difference during the lockdown period (Feb-Apr) between 2019 and 2020. 
`gdp_trillion`: log of 2019 GDP in billions
`pop_million`: log of 2019 population in thousands
