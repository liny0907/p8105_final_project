...
`city_period_diff` will hold each city's mean daily AQI difference of each pollutant, between 2019 Feb~Aprl and 2020 Feb~Aprl. 
```{r}
city_period_diff = 
...
This interactive plot shows each pollutant's Daily AQI difference, the value from 2020 Feb-Aprl minus the value from 2019 Feb~Aprl, in each city. A negative AQI change here indicates improvements in air quality. The users can click on the dropdown selection button on the top left to choose the pollutant type: PM2.5, PM10, O3, NO2, SO2 and CO. For PM2.5,PM10, CO and NO2, the mean AQI for most cities droped during the lockdown, showing general improvements in air quality. While for SO2 and O3, there are more cities with increased AQI during lockdown, with the O3 level increased for most of the cities in China..
...
This interactive plot shows each pollutant's Daily AQI Distribution, 2019 and 2020 Feb-Aprl, in each city. The users can click on the dropdown selection button on the top left to choose the pollutant type: PM2.5, PM10, O3, NO2, SO2 and CO. Each city has two boxes. The blue one represents the 2020 Feb-Aprl period, and the red one represents the 2021 Feb-Aprl period. Besides, the median, min, max, q1, q3 and outliers are showed in the box plot for each city. 
...
```
These line charts show the daily NO2 AQI starting from Feb1 to Apr 30. For each city, the blue line represents data from 2020, and red line represents data from 2019. 
Although there are fluctuations, generally the daily NO2 AQI during the lockdown is lower than the same period in year 2019, for each city.
...
This bar graph shows the PM2.5 AQI mean from Feb to Apr in the past four years for 30 cities. (note Xining does not have mean of 2021.) From the graph, the trend for PM2.5 AQI mean is decreasing and then increasing for most of 30 cities. The mean AQI in 2020 is the lowest one compared with other 3 years Due to the lock down from 2019 to 2021. The mean AQI in 2021 get back up because of the economy recovery. 
...
This bar graph shows the PM2.5 NO2 mean from Feb to Apr in the past four years for 30 cities. (note Xining does not have mean of 2021.) From the graph, the trend for PM2.5 AQI mean is decreasing and then increasing for most of 30 cities. The mean AQI in 2020 is the lowest one compared with other 3 years Due to the lock down from 2019 to 2021. The mean AQI in 2021 get back up because of the economy recovery. 
