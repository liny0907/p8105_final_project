...
We can see that although there are fluctuations, generally daily PM2.5 AQI during the lockdown is lower than the same period in year 2019, for each city. Besides, some cities such as Beijing, changchun, Harbin, Shanghai, shijiazhuang, Tianjin, Yinchuan and Zhengzhou has the violent fluctuations compared with other cities. Most of them are located in North of China. That is partly because the north cities need more fuels to housing supply and heavy industry. 
...
These line charts show daily NO2 AQI starting from Feb 1 to Apr 30. Similar to PM2.5 AQI trends, daily NO2 AQI during the lockdown is generally lower than the same period in year 2019 for each city. The blue line represents data from 2020, and red line represents data from 2019. In the graphs, the red lines of year 2019 does not have data for Feb 29, but the blue lines of year 2020 do.    
We can see that although there are fluctuations, generally daily NO2 AQI during the lockdown is lower than the same period in year 2019 for each city. Besides, most of cities has the violent fluctuations compared with the line chart daily PM2.5 AQI. Only Nanning and shenzhen have relatively less fluctuations among 30 cities. In overall, the trends for NO2 API in 2020 is decreasing. 
