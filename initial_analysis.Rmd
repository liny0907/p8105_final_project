...
## Time period
The time that we are interested in are from 
...
## Air quality data
Get the filenames of the air quality data, and tidy the data and create a `city_period_diff` to see the difference for Air pollutant.  
```{r}
...
This plot shows each pollutant's Daily AQI Distribution, 2019 and 2020 Feb-Aprl, in each city.The bar on the left top are selective bar that can be used to choose PM2.5, PM10, O3, NO2, SO2 and CO. Each shows the 30 cities Daily AQI distribution for each pollutant. For PM2.5,PM10, CO and NO2, the mean AQI difference is obviously showed and most of cities have improvements. But for SO2 and O3, the improvements are showed in half cities. 
...
This plot shows each pollutant's Daily AQI Distribution, 2019 and 2020 Feb-Aprl, in each city.The bar on the left top are selective bar that can be used to choose PM2.5, PM10, O3, NO2, SO2 and CO. Each shows the 30 cities 2019 and 2020 Feb-Apr period AQI distribution for each pollutant. Each city has two box plot for them. The blue one shows the 2020 Feb-Apr. The red one shows the 2021 Feb-Apr. Besides, the median, min, max, q1, q3 and outliers are showed in the box plot for each city. 
...
```
This line plot shows daily PM2.5 AQI data starting from Feb1 to Apr 30. The blue line are data for 2020 and red line are data for 2019. From the graphs, we can see some data are missing for 2019. The date "Feb 29" are missing in year 2019. But that is showing in year 2020. 
...
```
This line plot shows daily NO2 AQI data starting from Feb1 to Apr 30. The blue line are data for 2020 and red line are data for 2019. From the graphs, we can see some data are missing for 2019. The date "Feb 29" are missing in year 2019. But that is showing in year 2020. 
